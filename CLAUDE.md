...
- README stats (review count, categories, repo size, "Last Updated" shields.io badge) are auto-updated by `update_metadata.py` via pre-commit hook. Updates 3 READMEs: main, mike-paper-reviews-all, and presentations.
