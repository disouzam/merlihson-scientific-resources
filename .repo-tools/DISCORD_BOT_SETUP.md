...
**Edit:** `/Users/michaelerlihson/Personal/Projects/scientific_repo/.repo-tools/config/discord_config.yaml`
...
```bash
cd /Users/michaelerlihson/Personal/Projects/scientific_repo/.repo-tools/scripts
...
python3 /Users/michaelerlihson/Personal/Projects/scientific_repo/.repo-tools/scripts/discord_poster.py --test-webhook
```
