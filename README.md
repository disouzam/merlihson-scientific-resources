...
- **595 comprehensive paper reviews** covering cutting-edge AI/ML research (2022-2026)
...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_595.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_595.md` |
...
The core collection containing **595 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-595 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 595 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 228 English review markdown files
- **`split-reviews-docx/`** - 595 DOCX source files (`Review_001.docx` → `Review_595.docx`)
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 595 |
| **Hebrew Reviews (Markdown)** | 595 files |
| **English Reviews (Markdown)** | 228 files |
| **Reviews with Paper Links** | 594 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 595 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_595.md
│   ├── split-english-reviews-md/    # 228 English review markdown files
│   ├── split-reviews-docx/          # 595 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_595.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 594 reviews with links
...
### Researchers
- **Literature Reviews**: 595 analyzed papers with critical insights
