...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_579.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_579.md` |
...
The core collection containing **579 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-579 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 579 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 212 English review markdown files
- **`split-reviews-docx/`** - 579 DOCX source files (`Review_001.docx` → `Review_579.docx`)
...
|--------|-------|
| **Total Reviews** | 579 |
| **With Paper Links** | 578 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 579 |
| **Hebrew Reviews (Markdown)** | 579 files |
| **English Reviews (Markdown)** | 212 files |
| **Reviews with Paper Links** | 578 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 579 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_579.md
│   ├── split-english-reviews-md/    # 212 English review markdown files
│   ├── split-reviews-docx/          # 579 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_579.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 578 reviews with links
...
### Researchers
- **Literature Reviews**: 579 analyzed papers with critical insights
