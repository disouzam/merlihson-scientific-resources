...
[![Last Updated](https://img.shields.io/badge/Updated-May_2026-success.svg)](#)
...
- **608 comprehensive paper reviews** covering cutting-edge AI/ML research (2022-2026)
...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_608.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_608.md` |
...
The core collection containing **608 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-608 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 608 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 241 English review markdown files
- **`split-reviews-docx/`** - 608 DOCX source files (`Review_001.docx` → `Review_608.docx`)
...
|--------|-------|
| **Total Reviews** | 608 |
| **With Paper Links** | 606 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 608 |
| **Hebrew Reviews (Markdown)** | 608 files |
| **English Reviews (Markdown)** | 241 files |
| **Reviews with Paper Links** | 606 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 608 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_608.md
│   ├── split-english-reviews-md/    # 241 English review markdown files
│   ├── split-reviews-docx/          # 608 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_608.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 606 reviews with links
...
### Researchers
- **Literature Reviews**: 608 analyzed papers with critical insights
