...
- **580 comprehensive paper reviews** covering cutting-edge AI/ML research (2022-2026)
...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_580.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_580.md` |
...
The core collection containing **580 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-580 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 580 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 213 English review markdown files
- **`split-reviews-docx/`** - 580 DOCX source files (`Review_001.docx` → `Review_580.docx`)
...
|--------|-------|
| **Total Reviews** | 580 |
| **With Paper Links** | 579 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 580 |
| **Hebrew Reviews (Markdown)** | 580 files |
| **English Reviews (Markdown)** | 213 files |
| **Reviews with Paper Links** | 579 (100% coverage!) |
| **Daily Reviews** | 209 (May 2024 - Feb 2026) |
| **Learning Categories** | 22 |
| **Presentations** | 14 |
| **Total Repository Size** | 2.4 GB |
...
│   ├── split-hebrew-reviews-md/     # 580 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_580.md
│   ├── split-english-reviews-md/    # 213 English review markdown files
│   ├── split-reviews-docx/          # 580 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_580.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 579 reviews with links
...
### Researchers
- **Literature Reviews**: 580 analyzed papers with critical insights
