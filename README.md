...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_598.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_598.md` |
...
The core collection containing **598 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-598 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 598 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 231 English review markdown files
- **`split-reviews-docx/`** - 598 DOCX source files (`Review_001.docx` → `Review_598.docx`)
...
|--------|-------|
| **Total Reviews** | 598 |
| **With Paper Links** | 597 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 598 |
| **Hebrew Reviews (Markdown)** | 598 files |
| **English Reviews (Markdown)** | 231 files |
| **Reviews with Paper Links** | 597 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 598 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_598.md
│   ├── split-english-reviews-md/    # 231 English review markdown files
│   ├── split-reviews-docx/          # 598 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_598.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 597 reviews with links
...
### Researchers
- **Literature Reviews**: 598 analyzed papers with critical insights
