...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_600.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_600.md` |
...
The core collection containing **600 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-600 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 600 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 233 English review markdown files
- **`split-reviews-docx/`** - 600 DOCX source files (`Review_001.docx` → `Review_600.docx`)
...
|--------|-------|
| **Total Reviews** | 600 |
| **With Paper Links** | 599 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 600 |
| **Hebrew Reviews (Markdown)** | 600 files |
| **English Reviews (Markdown)** | 233 files |
| **Reviews with Paper Links** | 599 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 600 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_600.md
│   ├── split-english-reviews-md/    # 233 English review markdown files
│   ├── split-reviews-docx/          # 600 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_600.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 599 reviews with links
...
### Researchers
- **Literature Reviews**: 600 analyzed papers with critical insights
