...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_588.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_588.md` |
...
The core collection containing **588 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-588 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 588 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 221 English review markdown files
- **`split-reviews-docx/`** - 588 DOCX source files (`Review_001.docx` → `Review_588.docx`)
...
|--------|-------|
| **Total Reviews** | 588 |
| **With Paper Links** | 587 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 588 |
| **Hebrew Reviews (Markdown)** | 588 files |
| **English Reviews (Markdown)** | 221 files |
| **Reviews with Paper Links** | 587 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 588 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_588.md
│   ├── split-english-reviews-md/    # 221 English review markdown files
│   ├── split-reviews-docx/          # 588 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_588.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 587 reviews with links
...
### Researchers
- **Literature Reviews**: 588 analyzed papers with critical insights
