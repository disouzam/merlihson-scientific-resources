...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_601.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_601.md` |
...
The core collection containing **601 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-601 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 601 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 234 English review markdown files
- **`split-reviews-docx/`** - 601 DOCX source files (`Review_001.docx` → `Review_601.docx`)
...
|--------|-------|
| **Total Reviews** | 601 |
| **With Paper Links** | 600 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 601 |
| **Hebrew Reviews (Markdown)** | 601 files |
| **English Reviews (Markdown)** | 234 files |
| **Reviews with Paper Links** | 600 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 601 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_601.md
│   ├── split-english-reviews-md/    # 234 English review markdown files
│   ├── split-reviews-docx/          # 601 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_601.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 600 reviews with links
...
### Researchers
- **Literature Reviews**: 601 analyzed papers with critical insights
