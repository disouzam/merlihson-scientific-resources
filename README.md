...
- **576 comprehensive paper reviews** covering cutting-edge AI/ML research (2022-2026)
...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_576.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_576.md` |
...
The core collection containing **576 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 368-574 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 576 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 209 English review markdown files
- **`split-reviews-docx/`** - 576 DOCX source files (`Review_001.docx` → `Review_576.docx`)
...
|--------|-------|
| **Total Reviews** | 576 |
| **With Paper Links** | 575 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 576 |
| **Hebrew Reviews (Markdown)** | 576 files |
| **English Reviews (Markdown)** | 209 files |
| **Reviews with Paper Links** | 575 (100% coverage!) |
| **Daily Reviews** | 368 (May 2024 - Feb 2026) |
...
│   ├── split-hebrew-reviews-md/     # 576 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_576.md
│   ├── split-english-reviews-md/    # 209 English review markdown files
│   ├── split-reviews-docx/          # 576 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_576.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 575 reviews with links
...
### Researchers
- **Literature Reviews**: 576 analyzed papers with critical insights
