...
<h3>🎯 1,366 PDFs</h3>
<b>Resources</b><br>
<sub>12 GB of books,<br>cheat sheets & more</sub>
</td>
<td align="center" width="25%">
<h3>📅 2022-26</h3>
...
- **596 comprehensive paper reviews** covering cutting-edge AI/ML research (2022-2026)
- **23 learning categories** with 1,366 PDFs spanning machine learning, mathematics, algorithms, and more
...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_596.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_596.md` |
...
The core collection containing **596 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-596 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 596 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 229 English review markdown files
- **`split-reviews-docx/`** - 596 DOCX source files (`Review_001.docx` → `Review_596.docx`)
...
**22 specialized categories** with 1,366 PDFs (12 GB) of educational resources:
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 596 |
| **Hebrew Reviews (Markdown)** | 596 files |
| **English Reviews (Markdown)** | 229 files |
| **Reviews with Paper Links** | 595 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 596 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_596.md
│   ├── split-english-reviews-md/    # 229 English review markdown files
│   ├── split-reviews-docx/          # 596 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_596.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 595 reviews with links
...
│
├── learning-materials/              # Educational resources (12 GB, 1,366 PDFs)
│   ├── machine learning/            # 14 subcategories, 293 PDFs
│   ├── math/                        # 25 subcategories, 307 PDFs
│   ├── programming/                 # 17 subcategories, 85 PDFs
...
### Researchers
- **Literature Reviews**: 596 analyzed papers with critical insights
...
### Students
- **Structured Learning**: 22 categories with 1,366 PDFs of educational materials
