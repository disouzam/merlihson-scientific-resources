...
<h3>🎯 1,280 PDFs</h3>
<b>Resources</b><br>
<sub>11 GB of books,<br>cheat sheets & more</sub>
</td>
<td align="center" width="25%">
<h3>📅 2022-26</h3>
...
- **594 comprehensive paper reviews** covering cutting-edge AI/ML research (2022-2026)
- **23 learning categories** with 1,280 PDFs spanning machine learning, mathematics, algorithms, and more
...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_594.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_594.md` |
...
The core collection containing **594 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-594 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 594 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 227 English review markdown files
- **`split-reviews-docx/`** - 594 DOCX source files (`Review_001.docx` → `Review_594.docx`)
...
|--------|-------|
| **Total Reviews** | 594 |
| **With Paper Links** | 593 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 594 |
| **Hebrew Reviews (Markdown)** | 594 files |
| **English Reviews (Markdown)** | 227 files |
| **Reviews with Paper Links** | 593 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 594 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_594.md
│   ├── split-english-reviews-md/    # 227 English review markdown files
│   ├── split-reviews-docx/          # 594 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_594.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 593 reviews with links
...
│
├── learning-materials/              # Educational resources (11 GB, 1,280 PDFs)
│   ├── machine learning/            # 14 subcategories, 293 PDFs
│   ├── math/                        # 25 subcategories, 307 PDFs
│   ├── programming/                 # 17 subcategories, 85 PDFs
...
### Researchers
- **Literature Reviews**: 594 analyzed papers with critical insights
