...
- **590 comprehensive paper reviews** covering cutting-edge AI/ML research (2022-2026)
...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_591.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_591.md` |
...
The core collection containing **591 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-591 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 591 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 224 English review markdown files
- **`split-reviews-docx/`** - 591 DOCX source files (`Review_001.docx` → `Review_591.docx`)
...
|--------|-------|
| **Total Reviews** | 591 |
| **With Paper Links** | 590 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 591 |
| **Hebrew Reviews (Markdown)** | 591 files |
| **English Reviews (Markdown)** | 224 files |
| **Reviews with Paper Links** | 590 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 591 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_591.md
│   ├── split-english-reviews-md/    # 224 English review markdown files
│   ├── split-reviews-docx/          # 591 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_591.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 590 reviews with links
...
### Researchers
- **Literature Reviews**: 591 analyzed papers with critical insights
