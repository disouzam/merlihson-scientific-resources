...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_607.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_607.md` |
...
The core collection containing **607 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-607 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 607 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 240 English review markdown files
- **`split-reviews-docx/`** - 607 DOCX source files (`Review_001.docx` → `Review_607.docx`)
...
|--------|-------|
| **Total Reviews** | 607 |
| **With Paper Links** | 605 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 607 |
| **Hebrew Reviews (Markdown)** | 607 files |
| **English Reviews (Markdown)** | 240 files |
| **Reviews with Paper Links** | 605 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 607 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_607.md
│   ├── split-english-reviews-md/    # 240 English review markdown files
│   ├── split-reviews-docx/          # 607 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_607.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 605 reviews with links
...
### Researchers
- **Literature Reviews**: 607 analyzed papers with critical insights
