...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_590.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_590.md` |
...
The core collection containing **590 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-590 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 590 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 223 English review markdown files
- **`split-reviews-docx/`** - 590 DOCX source files (`Review_001.docx` → `Review_590.docx`)
...
|--------|-------|
| **Total Reviews** | 590 |
| **With Paper Links** | 589 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 590 |
| **Hebrew Reviews (Markdown)** | 590 files |
| **English Reviews (Markdown)** | 223 files |
| **Reviews with Paper Links** | 589 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 590 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_590.md
│   ├── split-english-reviews-md/    # 223 English review markdown files
│   ├── split-reviews-docx/          # 590 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_590.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 589 reviews with links
...
### Researchers
- **Literature Reviews**: 590 analyzed papers with critical insights
