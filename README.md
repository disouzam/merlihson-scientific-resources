...
<h3>🎯 1,230 PDFs</h3>
<b>Resources</b><br>
<sub>11.7 GB of books,<br>cheat sheets & more</sub>
</td>
<td align="center" width="25%">
<h3>📅 2022-26</h3>
...
- **23 learning categories** with 1,230 PDFs spanning machine learning, mathematics, algorithms, and more
...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_587.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_587.md` |
...
The core collection containing **587 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-587 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 587 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 220 English review markdown files
- **`split-reviews-docx/`** - 587 DOCX source files (`Review_001.docx` → `Review_587.docx`)
...
**23 specialized categories** with 1,230 PDFs (11.7 GB) of educational resources:
...
|--------|-------|
| **Total Reviews** | 587 |
| **With Paper Links** | 586 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 587 |
| **Hebrew Reviews (Markdown)** | 587 files |
| **English Reviews (Markdown)** | 220 files |
| **Reviews with Paper Links** | 586 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 587 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_587.md
│   ├── split-english-reviews-md/    # 220 English review markdown files
│   ├── split-reviews-docx/          # 587 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_587.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 586 reviews with links
...
│
├── learning-materials/              # Educational resources (11.7 GB, 1,230 PDFs)
│   ├── machine learning/            # 14 subcategories, 293 PDFs
│   ├── math/                        # 25 subcategories, 307 PDFs
│   ├── programming/                 # 17 subcategories, 85 PDFs
...
### Researchers
- **Literature Reviews**: 587 analyzed papers with critical insights
...
### Students
- **Structured Learning**: 23 categories with 1,230 PDFs of educational materials
