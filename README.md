...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_577.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_577.md` |
...
The core collection containing **577 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 369-574 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 577 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 210 English review markdown files
- **`split-reviews-docx/`** - 577 DOCX source files (`Review_001.docx` → `Review_577.docx`)
...
|--------|-------|
| **Total Reviews** | 577 |
| **With Paper Links** | 576 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 577 |
| **Hebrew Reviews (Markdown)** | 577 files |
| **English Reviews (Markdown)** | 210 files |
| **Reviews with Paper Links** | 576 (100% coverage!) |
| **Daily Reviews** | 369 (May 2024 - Feb 2026) |
...
│   ├── split-hebrew-reviews-md/     # 577 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_577.md
│   ├── split-english-reviews-md/    # 210 English review markdown files
│   ├── split-reviews-docx/          # 577 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_577.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 576 reviews with links
...
### Researchers
- **Literature Reviews**: 577 analyzed papers with critical insights
