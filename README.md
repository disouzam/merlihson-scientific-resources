...
- **599 comprehensive paper reviews** covering cutting-edge AI/ML research (2022-2026)
...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_599.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_599.md` |
...
The core collection containing **599 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-599 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 599 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 232 English review markdown files
- **`split-reviews-docx/`** - 599 DOCX source files (`Review_001.docx` → `Review_599.docx`)
...
**22 specialized categories** with 1,459 PDFs (13 GB) of educational resources:
...
|--------|-------|
| **Total Reviews** | 599 |
| **With Paper Links** | 598 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 599 |
| **Hebrew Reviews (Markdown)** | 599 files |
| **English Reviews (Markdown)** | 232 files |
| **Reviews with Paper Links** | 598 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 599 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_599.md
│   ├── split-english-reviews-md/    # 232 English review markdown files
│   ├── split-reviews-docx/          # 599 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_599.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 598 reviews with links
...
│
├── learning-materials/              # Educational resources (13 GB, 1,459 PDFs)
│   ├── machine learning/            # 14 subcategories, 293 PDFs
│   ├── math/                        # 25 subcategories, 307 PDFs
│   ├── programming/                 # 17 subcategories, 85 PDFs
...
### Researchers
- **Literature Reviews**: 599 analyzed papers with critical insights
...
### Students
- **Structured Learning**: 22 categories with 1,459 PDFs of educational materials
