...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_597.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_597.md` |
...
The core collection containing **597 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-597 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 597 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 230 English review markdown files
- **`split-reviews-docx/`** - 597 DOCX source files (`Review_001.docx` → `Review_597.docx`)
...
|--------|-------|
| **Total Reviews** | 597 |
| **With Paper Links** | 596 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 597 |
| **Hebrew Reviews (Markdown)** | 597 files |
| **English Reviews (Markdown)** | 230 files |
| **Reviews with Paper Links** | 596 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 597 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_597.md
│   ├── split-english-reviews-md/    # 230 English review markdown files
│   ├── split-reviews-docx/          # 597 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_597.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 596 reviews with links
...
### Researchers
- **Literature Reviews**: 597 analyzed papers with critical insights
