...
- **575 comprehensive paper reviews** covering cutting-edge AI/ML research (2022-2026)
...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_575.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_575.md` |
...
The core collection containing **575 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 367-574 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 575 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 208 English review markdown files
- **`split-reviews-docx/`** - 575 DOCX source files (`Review_001.docx` → `Review_575.docx`)
...
|--------|-------|
| **Total Reviews** | 575 |
| **With Paper Links** | 574 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 575 |
| **Hebrew Reviews (Markdown)** | 575 files |
| **English Reviews (Markdown)** | 208 files |
| **Reviews with Paper Links** | 574 (100% coverage!) |
| **Daily Reviews** | 367 (May 2024 - Feb 2026) |
...
│   ├── split-hebrew-reviews-md/     # 575 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_575.md
│   ├── split-english-reviews-md/    # 208 English review markdown files
│   ├── split-reviews-docx/          # 575 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_575.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 574 reviews with links
...
### Researchers
- **Literature Reviews**: 575 analyzed papers with critical insights
