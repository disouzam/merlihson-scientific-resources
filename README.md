...
- **609 comprehensive paper reviews** covering cutting-edge AI/ML research (2022-2026)
...
|---------------|------------------|
| Individual review files (DOCX) | `mike-paper-reviews-all/split-reviews-docx/Review_001.docx` - `Review_609.docx` |
| Individual reviews (Markdown) | `mike-paper-reviews-all/split-hebrew-reviews-md/Review_001.md` - `Review_609.md` |
...
The core collection containing **609 individual paper reviews** in multiple formats.

| Type | Count | Description |
|------|-------|-------------|
| **Individual Reviews** | 1-208 | Deep-dive analyses with paper links |
| **Daily Reviews** | 209-609 | Chronological reviews (May 2024 - Feb 2026) |

#### Formats Available
- **`split-hebrew-reviews-md/`** - 609 Hebrew review markdown files (primary format)
- **`split-english-reviews-md/`** - 242 English review markdown files
- **`split-reviews-docx/`** - 609 DOCX source files (`Review_001.docx` → `Review_609.docx`)
...
|--------|-------|
| **Total Reviews** | 609 |
| **With Paper Links** | 607 (100% coverage!) |
| **Auto-Extracted** | 571 |
| **Manually Added** | 1 |
...
| Metric | Value |
|--------|-------|
| **Total Paper Reviews** | 609 |
| **Hebrew Reviews (Markdown)** | 609 files |
| **English Reviews (Markdown)** | 242 files |
| **Reviews with Paper Links** | 607 (100% coverage!) |
...
│   ├── split-hebrew-reviews-md/     # 609 Hebrew review markdown files ⭐
│   │   ├── Review_001.md
│   │   ├── Review_002.md
│   │   └── ... → Review_609.md
│   ├── split-english-reviews-md/    # 242 English review markdown files
│   ├── split-reviews-docx/          # 609 DOCX source files
│   │   ├── Review_001.docx
│   │   └── ... → Review_609.docx
│   ├── reviews_metadata/            # Auto-updated metadata (100% coverage) 🤖
│   │   ├── paper_with_links.csv     # 607 reviews with links
...
### Researchers
- **Literature Reviews**: 609 analyzed papers with critical insights
